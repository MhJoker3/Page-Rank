...
public class Helper {
    ...
    public static void main(String[] args) throws IOException{
        ...
        BufferedReader pr = new BufferedReader(new FileReader("/Users/mhjoker/src/Project3-2/CSV/pr3.txt"));
        BufferedReader transition = new BufferedReader(new FileReader("/Users/mhjoker/src/Project3-2/src/main/java/transition.txt"));
        FileWriter fileWriter = new FileWriter("/Users/mhjoker/src/Project3-2/CSV/pr3.csv");
